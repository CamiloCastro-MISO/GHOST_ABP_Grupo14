...
$env:NODE_VIRTUAL_ENV="C:\Users\DELL\Documents\COURSERA\MISO\Repositories\GHOST_ABP_Grupo14\venv_kraken"
...
function global:prompt {
    Write-Host -NoNewline -ForegroundColor Green '(venv_kraken) '
    _OLD_VIRTUAL_PROMPT
}
