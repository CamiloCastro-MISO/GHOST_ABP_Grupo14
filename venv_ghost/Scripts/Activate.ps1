...
$env:NODE_VIRTUAL_ENV="C:\Users\DELL\Documents\COURSERA\MISO\4. Pruebas automatizadas de software\Ghost\node_venv"
...
function global:prompt {
    Write-Host -NoNewline -ForegroundColor Green '(node_venv) '
    _OLD_VIRTUAL_PROMPT
}
